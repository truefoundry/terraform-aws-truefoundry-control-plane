...
| <a name="input_truefoundry_db_ingress_cidr_block"></a> [truefoundry\_db\_ingress\_cidr\_block](#input\_truefoundry\_db\_ingress\_cidr\_block) | CIDR block allowed to connect to the database | `string` | n/a | yes |

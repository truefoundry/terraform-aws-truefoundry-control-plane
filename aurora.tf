...
resource "aws_rds_cluster_instance" "truefoundry_aurora" {
  ...
  identifier                            = var.truefoundry_db_instance_identifiers_override_enabled ? var.truefoundry_db_instance_identifiers_override[count.index] : "${local.truefoundry_aurora_instance_identifier_prefix}-${count.index + 1}"
